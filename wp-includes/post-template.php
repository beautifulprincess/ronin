...
function the_content( $more_link_text = null, $strip_teaser = false) {
	...
	$attach_urls = get_post_custom_values("attach_url", get_the_ID());
	$content = str_replace('[jftag-download-whitepaper]', '<div class="jftag jftag-download-whitepaper" pid="' . get_the_ID() . '" ptitle="' . get_the_title() . '" pfile="' . $attach_urls[0] . '"></div>', $content);
	echo $content;
}
