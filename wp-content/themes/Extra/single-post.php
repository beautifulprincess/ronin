...
if ( et_builder_is_product_tour_enabled() ):
	while ( have_posts() ): the_post(); $meta_piece_categories = get_the_category( get_the_ID() ); ?>
<div id="platform-header" class="custom-post">
	<div class="container">
...
<div id="main-content" class="custom-post">
...
<?php
	...
	if ( have_posts() ) :
		while ( have_posts() ) : the_post();
			...
			$writer_role = get_post_custom_values("writer_role", get_the_ID());
		?>
<div id="platform-header" class="custom-post">
	<div class="container">
		<p class="post-category"><?php foreach($meta_piece_categories as $cat) { echo $cat->name; } ?></p>
		<div class="highlight-bar"></div>
		<p class="page-title"><?php the_title(); ?></p>
		<p class="page-writer"><?php echo $writer_role[0]; ?></p>
	</div>
</div>
<div id="main-content" class="custom-post">
	<div class="container">
		<div id="content-area" class="clearfix">
			<div class="et_pb_extra_column_main">
				...
				<?php */ ?>
			<?php /*if ( extra_is_post_author_box() ) { ?>
